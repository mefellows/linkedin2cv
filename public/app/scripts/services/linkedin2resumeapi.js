...
var linkedin2resumeServices = angular.module('linkedin2resumeServices', ['ngResource']);

linkedin2resumeServices.factory('Linkedin2Resume', ['$q', '$rootScope', '$interval', function($q, $rootScope, $interval) {
